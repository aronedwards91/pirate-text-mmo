...
export const factions: Record<Faction, FactionData> = {
  [FactionKey.churchMachine]: {
    ...
    age: "new",
    resources: "strong",
    description: "The fervour of the church knows no bounds, they have seen what man can become when merged with machine. The missionaries of the church use coercion, bribery, trickery and all manner of methods that would be swiftly outlawed on a planted ruled by law",
  ...
  [FactionKey.moonsRebirth]: {
    ...
    age: "old",
    resources: "plentiful",
    description: "The strange powers of the moon have given bold new direction to this ancient cult, who now see the planet as their holy place, and one that must not be defiled.",
